          ...
          <div className="text-[#15202b] p-15 leading-8 text-lg font-medium  mt-6 rounded-2xl bg-[#f9f9f9] shadow-lg text-left w-[280px] sm:w-[500px]  md:w-[800px] lg:w-[1000px] xl:w-[1300px] 2xl:w-[1800px]">
            <div className="">
              ...
              <div className="flex items-center gap-5 my-5">
                ...
                <a
                  href="https://github.com/kaanatakanyilmaz/React-Study-Case"
                  target="_blank"
                >
                  <div className="">
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  <span className="font-bold">-- Create React App:</span> Used
                  as the boilerplate for setting up the project.
                </li>
              </ul>
              <h2 className="font-bold text-2xl mt-5">Additional Libraries</h2>
              <ul>
                <li>
                  <span className="font-bold">-- Axios:</span> Used for making
                  HTTP requests to fetch and send data.
                </li>
                <li>
                  <span className="font-bold">-- Context API:</span> Utilized
                  for state management and sharing data across components.
                </li>
                <li>
                  <span className="font-bold">-- Bootstrap:</span> A popular CSS
                  framework for styling and responsive design.
                </li>
                <li>
                  <span className="font-bold">-- React Router DOM:</span>
                  Enables navigation and routing between pages.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  Efficient data handling using React Context API.
                </li>
              </ul>
            </div>
          </div>
